...
$(window).on('load', function () {
  ...
  var $participantsChart = document.querySelector('#participants-chart');
  ...
  participantsChart = new ApexCharts($participantsChart, participantsChartOptions);
