...
$(function () {
  ...
  var donutChartEl = document.querySelector('#donut-chart'),
    donutChartConfig = {
      ...
      labels: ['قيد التأليف', 'قيد التصميم', 'قيد الاخراج', 'مكتمل'],
      series: [85, 16, 50, 50],
      colors: [
  ...
  // Donut Chart
  // --------------------------------------------------------------------
  var donutChartEl2 = document.querySelector('#donut-chart2'),
    donutChartEl2Config = {
      chart: {
        height: 350,
        type: 'donut'
  ...
  if (typeof donutChartEl2 !== undefined && donutChartEl2 !== null) {
    var donutChart2 = new ApexCharts(donutChartEl2, donutChartEl2Config);
    donutChart2.render();
  }
