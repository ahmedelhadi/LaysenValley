...
$(function () {
  ...
  var id = $('.dnaform').data('id');


  var bsStepper = document.querySelectorAll('.dnaform'+id+' .bs-stepper'),
    select = $('.select2'),
    //horizontalWizard = document.querySelector('.horizontal-wizard-example'),
    horizontalWizard = document.querySelector('.dnaform'+id+' .horizontal-wizard-example'),

    horizontalWizard2 = document.querySelector('.horizontal-wizard-example2'),
  ...
  // Horizontal Wizard
  // --------------------------------------------------------------------
  if (typeof horizontalWizard2 !== undefined && horizontalWizard2 !== null) {
    var numberedStepper2 = new Stepper(horizontalWizard2),
      $form = $(horizontalWizard2).find('form');
    $form.each(function () {
      var $this = $(this);
      $this.validate({
        rules: {
