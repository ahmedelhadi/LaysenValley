    ...
    @foreach (Config::get('languages') as $lang => $language)
        ...
        <div class="tab-pane @if ($lang==App::getLocale()) fade active show @endif" id="{{ $lang }}" aria-labelledby="{{ $lang }}-tab" role="tabpanel">
            ...
            <div class="mb-2">
                ...
                {!! Form::text('title[' . $lang . ']', $attribute->title[$lang] ?? '', ['required', 'class' => 'form-control', 'autocomplete' => 'off', 'id' => 'title_' . $lang]) !!}
            </div>


            <div class="mb-2">
                {!! Form::label('desc-' . $lang, trans('admin.body') . ' - ' . $language , ['class' => 'form-label']) !!}
                {!! Form::textarea('desc[' . $lang . ']', $attribute->desc[$lang] ?? '' , [ 'class' => 'textarea form-control ckeditor', 'id' => 'ckeditor', 'placeholder' => trans('admin.desc'), 'rows' => 5 ]) !!}
            </div>
        ...
        <div class="row">
            <div class="col-1">
                <a href="" data-bs-toggle="modal" data-bs-target="#image">
                    <img src="{{ url($attribute->image) }}" class="img-fluid rounded-lg">
                </a>

                @include('admin.parts.modal',['id' => 'image','url' => url($attribute->image) ])
...
<div class="mb-2">
    {!! Form::label('icon', trans('admin.image') , ['class' => 'form-label'] ) !!}
    @if(isset($attribute->icon))
        <div class="row">
            <div class="col-1">
                <a href="" data-bs-toggle="modal" data-bs-target="#icon">
                    <img src="{{ url($attribute->icon) }}" class="img-fluid rounded-lg">
                </a>

                @include('admin.parts.modal',['id' => 'icon','url' => url($attribute->icon) ])
...
<div class="mb-2">
    {!! Form::label('block_id', trans('admin.block') , ['class' => 'form-label'] ) !!}
    {!! Form::select('block_id', $blocks->pluck('title.'.App::getLocale(),'id'), $attribute->block_id ?? Request::get('page_id'), [ 'class' => 'form-control','placeholder'=>trans('admin.choose')]) !!}
</div>



<div class="mb-2">
    {!! Form::label('counter', trans('admin.counter') , ['class' => 'form-label'] ) !!}
    {!! Form::text('counter', $attribute->counter ?? 1, [ 'class' => 'form-control']) !!}
</div>

<div class="mb-2">
    {!! Form::label('video_id', trans('admin.counter') , ['class' => 'form-label'] ) !!}
    {!! Form::text('video_id', $attribute->video_id ?? null, [ 'class' => 'form-control']) !!}
</div>

<div class="mb-2">
    {!! Form::label('button_text', trans('admin.button_text') , ['class' => 'form-label'] ) !!}
    {!! Form::text('button_text', $attribute->button_text ?? null, [ 'class' => 'form-control']) !!}
</div>

<div class="mb-2">
    {!! Form::label('button_link', trans('admin.button_link') , ['class' => 'form-label'] ) !!}
    {!! Form::text('button_link', $attribute->button_link ?? null, [ 'class' => 'form-control']) !!}
</div>

<div class="mb-2">
    {!! Form::label('sort', trans('admin.sort') , ['class' => 'form-label'] ) !!}
    {!! Form::text('sort', $attribute->sort ?? 1, ['required', 'class' => 'form-control']) !!}
</div>

<div class="mb-2">
    {!! Form::label('is_active', trans('admin.status') , ['class' => 'form-label'] ) !!}
    {!! Form::select('is_active', ['1' => trans('admin.yes'), '0' => trans('admin.no')], $attribute->is_active ?? 1, ['required', 'class' => 'form-control']) !!}
</div>
