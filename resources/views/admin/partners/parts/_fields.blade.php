...
<div class="mb-2">
    ...
    {!! Form::text('title['.App::getLocale().']', $partner->title[App::getLocale()] ?? '', ['required', 'class' => 'form-control', 'autocomplete' => 'off', 'id' => 'title_ar']) !!}

</div>

<div class="mb-2">
    {!! Form::label('sub_title-ar', trans('admin.title') , ['class' => 'form-label'] ) !!}
    {!! Form::text('sub_title['.App::getLocale().']', $partner->sub_title[App::getLocale()] ?? '', ['required', 'class' => 'form-control', 'autocomplete' => 'off', 'id' => 'title_ar']) !!}
</div>
...
<div class="mb-2">
    ...
    {!! Form::textarea('desc['.App::getLocale().']', $partner->desc[App::getLocale()]  ?? '' , [ 'class' => 'textarea form-control ckeditor', 'id' => 'ckeditor', 'placeholder' => trans('admin.desc'), 'rows' => 5 ]) !!}
</div>
